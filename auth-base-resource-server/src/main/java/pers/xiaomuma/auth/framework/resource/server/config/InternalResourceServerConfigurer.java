...
public class InternalResourceServerConfigurer extends ResourceServerConfigurerAdapter {
    ...
    public InternalResourceServerConfigurer(RestTemplate restTemplate, ObjectMapper objectMapper,
