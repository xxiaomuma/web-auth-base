...
public class CustomizedAuthorizationServerSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private CustomizedAuthorizationServerEndpointsConfiguration endpoints;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		// composed of the ClientDetailsService (wired in this configuration) for authenticating 'client' only.
	}
